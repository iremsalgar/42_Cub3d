...
void	images_to_xpm(t_mlx *wind)
{
	...
	wind->n_xpm = mlx_xpm_file_to_image(wind->mlx, wind->data->north_path, &w, &h);
	wind->s_xpm = mlx_xpm_file_to_image(wind->mlx, wind->data->south_path, &w, &h);
	wind->e_xpm = mlx_xpm_file_to_image(wind->mlx, wind->data->east_path, &w, &h);
	wind->w_xpm = mlx_xpm_file_to_image(wind->mlx, wind->data->west_path, &w, &h);
